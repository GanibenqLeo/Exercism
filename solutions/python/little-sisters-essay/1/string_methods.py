...
def capitalize_title(title:str) -> str:
    ...
    print("La capitale de la France c'est Paris")
...
def check_sentence_ending(sentence:str) -> bool:
    ...
    print("La ponctuation n'a pas de ponctuation mais un point a un point")
...
def clean_up_spacing(sentence:str) -> str:
    ...
    print("Attention à ne pas marcher sur les mots mouillés")
...
def replace_word_choice(sentence:str, old_word:str, new_word:str) -> str:
    ...
    print("Monde.remplacer('Dictature', 'Démocratie')")
